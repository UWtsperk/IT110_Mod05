...
#   Thomas Perkins, 11/10/23, Modified for Assignment 05
# ------------------------------------------------------------------------------------------ #
...
while True:
    ...
    if menu_choice == "1":  # This will not work if it is an integer!
        student_first_name = ''  # Reset values to avoid bad reporting.
        student_last_name = ''
        course_name = ''
        try:
